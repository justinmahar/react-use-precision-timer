...
For convenience, you can use the [useDelay](https://justinmahar.github.io/react-use-precision-timer/?path=/story/docs-usedelay--page) hook, which encapsulates these options.
...
const stopwatch = useTimer(timerOptions);
```
...
For convenience, you can use the [useStopwatch](https://justinmahar.github.io/react-use-precision-timer/?path=/story/docs-usestopwatch--page) hook, which simplifies this option.
