...
Pass the hook a memoized [TimerOptions](#timeroptions) object to configure a timer's delay and the callback called when it fires. By default, the timer repeats.
...
You can test this in the [live demo](https://justinmahar.github.io/react-use-precision-timer/?path=/story/docs-demo--page) when you set a Delay under 10ms. Refer to the "Overdue call count" value.
