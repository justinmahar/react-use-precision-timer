...
For convenience, you can use the [useStopwatch](https://justinmahar.github.io/react-use-precision-timer/?path=/story/docs-usestopwatch--page) hook, which encapsulates this option.
