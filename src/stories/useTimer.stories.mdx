...
| Property | Type                                                   | Description                                                                                                                      |
| -------- | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| start    | `(startingElapsedMillis: number OR undefined) => void` | Start the timer. If already started, will restart the timer. You can optionally pass an elapsed starting amount in milliseconds. |
