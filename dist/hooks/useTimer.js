...
exports.useTimer = function(options) {
  ...
  var _b = React.useState(now),
    setCheckTime = _b[1];
  var _c = React.useState(false),
    started = _c[0],
    setStarted = _c[1];
  var _d = React.useState(never),
    startTime = _d[0],
    setStartTime = _d[1];
  var _e = React.useState(never),
    lastFireTime = _e[0],
    setLastFireTime = _e[1];
  var _f = React.useState(never),
    nextFireTime = _f[0],
    setNextFireTime = _f[1];
  var _g = React.useState(never),
    pauseTime = _g[0],
    setPauseTime = _g[1];
  var _h = React.useState(never),
    resumeTime = _h[0],
    setResumeTime = _h[1];
  var _j = React.useState(0),
    periodElapsedPauseTime = _j[0],
    setPeriodElapsedPauseTime = _j[1];
  var _k = React.useState(0),
    totalElapsedPauseTime = _k[0],
    setTotalElapsedPauseTime = _k[1];
  var isStarted = React.useCallback(
    function() {
      return started;
    },
    [started]
  );
  var isStopped = React.useCallback(
    function() {
      return !isStarted();
    },
    [isStarted]
  );
  var isPaused = React.useCallback(
    function() {
      return isStarted() && pauseTime !== never;
    },
    [isStarted, pauseTime]
  );
  var isRunning = React.useCallback(
    function() {
      return isStarted() && !isPaused();
    },
    [isPaused, isStarted]
  );
  var getStartTime = React.useCallback(
    function() {
      if (isStarted()) {
        return startTime;
      }
  ...
  var getPauseTime = React.useCallback(
    function() {
      if (isPaused()) {
        return pauseTime;
      }
  ...
  var getResumeTime = React.useCallback(
    function() {
  ...
  var getElapsedStartedTime = React.useCallback(
    function() {
      if (isStarted()) {
  ...
  var getElapsedRunningTime = React.useCallback(
    function() {
      if (isStarted()) {
        if (isPaused()) {
  ...
  var getPeriodElapsedPausedTime = React.useCallback(
    function() {
  ...
  var getTotalElapsedPausedTime = React.useCallback(
    function() {
      var additionalElapsedPauseTime = 0;
      if (isPaused()) {
        additionalElapsedPauseTime = new Date().getTime() - pauseTime;
  ...
  var getElapsedResumedTime = React.useCallback(
    function() {
      if (isRunning()) {
  ...
  var getRemainingTime = React.useCallback(
    function() {
